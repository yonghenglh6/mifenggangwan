...
function action_search_users ()
{
	...
	$sql = "SELECt a.user_id, a.user_name FROM " . $GLOBALS['ecs']->table('admin_user') . " AS a WHERE 1=1 " . $where;
	$sql = "SELECt a.user_id, a.user_name FROM " . $GLOBALS['ecs']->table('admin_user') . " AS a LEFT JOIN " . $GLOBALS['ecs']->table('chat_customer') . " AS b ON (a.user_id != b.user_id) WHERE 1=1 " . $where;
