...
{
    $sql="select * from ".$ecs->table('store_adminer')." where admin_id='" . $_SESSION['admin_id'] . "' order by store_id desc ";
    ...
    while ($store_row = $db->fetchRow($store_res))
    {
        ...
        $storelist = $storelist . "$store_id:$store_name" . "-";
    }
    $_SESSION['storelist'] = substr($storelist,0,strlen($storelist) - 1);
